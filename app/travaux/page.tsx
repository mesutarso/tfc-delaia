    ...
    return (
        <div className="flex flex-col gap-8">
            <div className='login w-[600px] bg-gray-200 '>
                <PageTitle title="Travaux techniques" />
                <div className="grid grid-cols-2 gap-8 p-8  ">
                    ...
                    <div>
                        <Link href='/editions'>
                            <span className='w-[100%] block py-3 px-8 bg-primary font-semibold outline-none uppercase text-white rounded-md'>backup</span>
                        </Link>
                    </div>
                    <div>
                        <Link href='/impression'>
                            <span className='w-[100%] block py-3 px-8 bg-primary font-semibold outline-none uppercase text-white rounded-md'>Restauration</span>
                        </Link>
                    </div>
                    <div>
                        <Link href='/travaux'>
                            <span className='w-[100%] block py-3 px-8 bg-primary font-semibold outline-none uppercase text-white rounded-md'>Installation</span>
                        </Link>
                    </div>
                </div>
